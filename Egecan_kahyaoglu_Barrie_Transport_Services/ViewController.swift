...
//  Egecan_kahyaoglu_Barrie_Transport_Services
//
//  Created by Egecan Kahyaoglu on 2019-11-20.
...
class ViewController: UIViewController {
    ...
    //class variables
    var model = EK_BTS_Model()
    
    override func viewDidLoad() {
        super.viewDidLoad()
        // Do any additional setup after loading the view.
        
        // barrie location coordinates
        let barrieLatitude = 44.389355
        let barrieLongitude = -79.690331
   
    
        let barrieLocation = CLLocationCoordinate2D(
            latitude: barrieLatitude, longitude: barrieLongitude)
...
class CustomAnnotationView : MKMarkerAnnotationView {
    override init(annotation: MKAnnotation?, reuseIdentifier: String?) {
        ...
        button.addTarget(self, action: #selector(CustomAnnotationView.makeTheCell(sender:)), for: .touchUpInside)
    ...
    @objc func makeTheCell(sender: UIButton) {
